...
// 		$scope.name = "홍길동";
		...
		$scope.imgs = [
			...
			{alt : '200', src : 'http://www.placehold.it/150x100/00ff00/0000ff?text=cat1'},
			{alt : '300', src : 'http://www.placehold.it/250x100/0000ff/ff00ff?text=dog'},
			{alt : '400', src : 'http://www.placehold.it/300x100/ff00ff/0000ff?text=dog1'},
			{alt : '500', src : 'http://www.placehold.it/350x100/ffff00/0000ff?text=zebra'}
		]
...
<table class="table table-condensed">
	<thead>
	<tr><th>No</th><th>deptno</th><th>dname</th><th>loc</th></tr>
	</thead>
	<tbody>
