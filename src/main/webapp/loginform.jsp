...
<body bgcolor="#ffffff" text="#000000">
	...
	<form action="/members.do" method="post" id="join">
		<table width="550" align="center" border="1" bordercolor="ADD8E6"
			...
			<tr>
				<td height="30" align="center" bgcolor="#FFDEAD">Email</td>
				<td bgcolor="#E0FFFF"><input type="email" id="email" name="member_email" size=20 maxlength="20"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<input type="button" id="back" value="뒤로가기" onclick="javascript:location.href='/user/login.jsp';"></td>
			</tr>
		</table>
	</form>
</body>
