        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li data-ng-hide="loginstatus"><a href="<c:url value="/user/login.html"/>"><i class="fa fa-sign-in fa-fw"></i> Login</a>
                    <li data-ng-show="loginstatus"><a href="<c:url value="/user/logout"/>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
